...
let lineVoltage = 0;
let gfciTripped = false;
let gfciReset = false;


const powerButton =
    document.querySelector("#powerButton");
...
lineVoltage = powerOn ? 120 : 0;

updatePowerStatus();

console.log(
    `Simulated line voltage: ${lineVoltage}V AC`
);
...
===================================================== */
    ...
    knockouts.forEach((knockout) => {
        ...
        knockout.addEventListener("click", (event) => {
